...
function EnrollCard() {
  return (
    <>
    <div className='d-flex justify-content-center' style={{width:'300px',height:'310px',borderRadius:'30px',flexDirection:'column',backgroundColor:'#f5f5f5',marginTop:'20px'}} >
